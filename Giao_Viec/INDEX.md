...
**Đừng bị confuse bởi các file:**
- `00_START_HERE.md` - Overview dự án (đọc nếu muốn hiểu big picture)
- `QUICK_START.md` - Docker startup (dùng khi bắt đầu)
- `QUICK_START_VIET.md` - Tóm tắt nhanh (optional)
- `README.md` - Tổng quát (optional)
